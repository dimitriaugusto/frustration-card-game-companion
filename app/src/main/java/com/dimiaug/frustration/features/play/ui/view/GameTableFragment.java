package com.dimiaug.frustration.features.play.ui.view;

import static com.dimiaug.frustration.features.play.ui.utils.StringUtils.isEmpty;
...
import com.dimiaug.frustration.features.play.ui.view.dialog.play.PlaysDialogBase;
...
public class GameTableFragment extends Fragment {
    ...
    private final PlayInjection mPlayInjection =
            (PlayInjection) inject(PlayInjection.class).getValue();
    ...
    private final GameTableViewModel mViewModel = mPlayInjection.getGameTableViewModel();
    ...
    private void initView() {
        ...
        mGameTableView = mPlayInjection.getGameTableView(getActivity());
    }

    private void initDialogs() {
        mFirstPlayDialog = mPlayInjection.getFirstPlayDialog(getContext());
        mNextPlayDialog = mPlayInjection.getNextPlayDialog(getContext());
        mEditPlayDialog = mPlayInjection.getEditPlayDialog(getContext());
        mResetGameDialog = mPlayInjection.getResetGameDialog(getContext());
    }
